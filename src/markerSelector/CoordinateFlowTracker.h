...
/**
	...
	*/
class CoordinateFlowTracker: CoordinateTracker {
public:
	...
	CoordinateFlowTracker(unsigned char *_currentImage, int _width, int _height, int _markerIndice, coordinate _coordinates, Histogram* _histogram, int _colorTolerance, std::vector<coordinate> *_samplingCoordinates,	std::vector<coordinate> *_searchCoordinates,unsigned char *_prevImage,unsigned char* _markerColor,double _markerRadius){
		super(_currentImage,_width,_height,_markerIndice,_coordinates,_histogram,_colorTolerance,_samplingCoordinates,_searchCoordinates);
	...
	void getCoordinates() {
		try {
			...
			std::vector<coordinate> areaCoordinates = TrackinThread::getMarkerCoordinatesRegionGrow(currentImage, width, height, startSearch,markerColor, colorTolerance,searchCoordinates,markerRadius);
